...
export default function TabContent3() {
    return (
        <Container>
            ...
            <TabList name='Williamsons ' surname='Williamsons' branch='Mabara,Abuja' amount='$124.00' />
            <TabList name='Williamsons ' surname='Williamsons' branch='Mabara,Abuja' amount='$124.00' />
            <TabList name='Williamsons'  amount='$124.00' />
            <TabList name='Williamsons ' surname='Williamsons' branch='Mabara,Abuja' amount='$124.00' />
            <TabList name='Williamsons ' surname='Williamsons' branch='Mabara,Abuja' amount='$124.00' />
            <TabList name='Williamsons ' surname='Williamsons' amount='$124.00' />
        </Container>
    )
}
